...
class InsuranceCompanyItem(models.Model):
    ...
    company = models.ForeignKey(Company, verbose_name="Şirket", on_delete=models.CASCADE)
    username = models.CharField(verbose_name="Kullanıcı Adı", max_length=255)
    password = models.CharField(verbose_name="Şifre", max_length=255)
    ...
    totp_code = models.CharField(verbose_name="Totp Kodu", max_length=255)
    phone_number = models.CharField(verbose_name="Telefon Numarası", max_length=255)
    proxy_url = models.CharField(verbose_name="Proxy URL", max_length=255)
    proxy_username = models.CharField(verbose_name="Proxy Kullanıcı Adı", max_length=255)
